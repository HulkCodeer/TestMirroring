...
internal final class TooltipView: UIView {
    ...
    internal struct Configure {
        ...
        fileprivate var font: UIFont = .systemFont(ofSize: 14, weight: .semibold)
    ...
    private func makeTooltip(message: String, attrString: String) {
        ...
        let attributes: [NSAttributedString.Key: Any] = [.font: UIFont.systemFont(ofSize: 16, weight: .regular), .foregroundColor: Colors.nt0.color]
