...
class LinkShareManager {
    ...
    func sendToKakao(with document: Document) {
        ...
        shareList["scheme"] = "kakaoLinkType=communityBoard&target_id=10&mid=\(document.board_id ?? "")&document_srl=\(document.document_srl ?? "")"
        shareList["ischeme"] = "kakaoLinkType=communityBoard&target_id=10&mid=\(document.board_id ?? "")&document_srl=\(document.document_srl ?? "")"
    ...
    func sendToKakao(with charger: ChargerStationInfo?) {
        ...
        shareList["scheme"] = "kakaoLinkType=charger&charger_id=\(charger.mChargerId ?? "")"
        shareList["ischeme"] = "kakaoLinkType=charger&charger_id=\(charger.mChargerId ?? "")"
        shareList["appstore"] = "https://itunes.apple.com/kr/app/ev-infra/id1206679515?mt=8";
        shareList["market"] = "https://play.google.com/store/apps/details?id=com.client.ev.activities"
