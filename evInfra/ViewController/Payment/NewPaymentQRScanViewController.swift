...
//    @IBOutlet weak var lbExplainScanner: UILabel!
    ...
    override func loadView() {
        ...
        self.contentView.addSubview(scannerViewLayerView)
        scannerViewLayerView.snp.makeConstraints {
            $0.top.equalTo(naviTotalView.snp.bottom)
            $0.leading.bottom.trailing.equalToSuperview()
        }
        
        scannerViewLayerView.addSubview(qrBoxImgView)
        qrBoxImgView.snp.makeConstraints {
            $0.center.equalToSuperview()
            $0.width.height.equalTo(216)
        }
        
        scannerViewLayerView.addSubview(guideLbl)
...
extension NewPaymentQRScanViewController: AVCaptureMetadataOutputObjectsDelegate {
    ...
    func prepareQRScanner() {
        ...
        videoPreviewLayer.frame = scannerViewLayerView.layer.bounds
        scannerViewLayerView.layer.addSublayer(videoPreviewLayer!)
        ...
        if let qrCodeFrameView = qrCodeFrameView {
            ...
            scannerViewLayerView.addSubview(qrCodeFrameView)
            scannerViewLayerView.bringSubview(toFront: qrCodeFrameView)
        }
    }
...
extension NewPaymentQRScanViewController {
