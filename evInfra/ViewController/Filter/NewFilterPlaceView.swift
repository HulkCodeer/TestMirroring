...
internal final class NewFilterPlaceView: CommonFilterView {
    ...
    func bind(reactor: FilterReactor) {
        for placeFilter in reactor.currentState.tempFilterModel.placeFilters {
            let filterTypeView = self.createCommonFilterTypeView(placeFilter, reactor: reactor)
            ...
            filterTypeView.btn.rx.tap
                ...
                .drive(with: self) { obj, _ in
                    ...
                    placeFilter.isSelected = filterTypeView.btn.isSelected
                    Observable.just(FilterReactor.Action.setAcessTypeFilter(placeFilter))
